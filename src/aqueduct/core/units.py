...
def convert_pressure_values(values: Tuple[Union[float, None]], from_unit: PressureUnits, to_unit: PressureUnits) -> Tuple[Union[float, None]]:
    """
...
def convert_weight_values(values: Tuple[Union[float, None]], from_unit: WeightUnits, to_unit: WeightUnits) -> Tuple[Union[float, None]]:
    """
    Converts weight values from one unit to another.

    :param values: The weight values to be converted.
    :type values: Tuple[Union[float, None]]
    :param from_unit: The unit of the input values.
    :type from_unit: WeightUnits
    :param to_unit: The desired unit for conversion.
